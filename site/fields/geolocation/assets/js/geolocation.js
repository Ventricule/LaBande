...
Geolocation = (function($){
  ...
  function init() {
    ...
    s = {
      ...
      defaultLat:    48.87708063548164,
      defaultLng:    2.4067490581053335,
    ...
    geocoder.geocode( { 'address': address}, function(results, status) {
      if (status == google.maps.GeocoderStatus.OK) {
        ...
        if (status == "ZERO_RESULTS") {
          alert("La recherche n'a retourné aucun résultat. Précisez l'adresse ou déplacez le marqueur manuellement.");
        } else {
